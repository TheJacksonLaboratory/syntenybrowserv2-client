        ...
        <table class="table table-compact">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="left">
                <a href="" target="_blank">MouseMineSynteny.blocks</a>
              </td>
            ...
            <tr>
              <td class="left">
                <b>2. Genomic Features (gene, QTL, mRNA, ...)</b>
              </td>
              <td class="left"></td>
              <td class="left"></td>
              <td class="left"></td>
            ...
            <tr>
              ...
              <td class="left">
                <a href="" target="_blank">NCBI_Human_forSynteny.gff3</a>
              </td>
            ...
            <tr>
              ...
              <td class="left">
                <a href="" target="_blank">MGI_GenomeFeature_forSynteny.gff3</a>
              </td>
              <td class="left">GFF3</td>
            ...
            <tr>
              ...
              <td class="left">
                <a href="" target="_blank">QTL_JBrowse.gff3</a>
              </td>
              <td class="left">GFF3</td>
            ...
            <tr>
              <td class="left">
                <b>5. Annotations (QTL, genes, mRNA, ...)</b>
              </td>
              <td class="left"></td>
              <td class="left"></td>
              <td class="left"></td>
